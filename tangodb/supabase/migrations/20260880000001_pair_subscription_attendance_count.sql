-- Pair group subscriptions count as two participants in attendance reports.

BEGIN;

CREATE OR REPLACE FUNCTION _group_subscription_participant_count(p_type text)
RETURNS integer
LANGUAGE sql
IMMUTABLE
SET search_path = public
AS $$
  SELECT CASE WHEN p_type IN ('pair', 'pair_hm') THEN 2 ELSE 1 END;
$$;
