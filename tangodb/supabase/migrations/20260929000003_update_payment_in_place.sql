-- In-place amount/method correction (no storno row) + restated billed amount
-- for personal-lesson charges. Extra void stornos on replaced originals can be deleted.
