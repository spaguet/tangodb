-- Early-finish subscription via RPC (bypasses protect_subscription_counters trigger)
...
REVOKE ALL ON FUNCTION finish_subscription(text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION finish_subscription(text) TO authenticated;
