-- Replace freeze_deducts_lesson with freeze_enabled; freeze never deducts lessons from balance.

ALTER TABLE organization_settings
  ADD COLUMN IF NOT EXISTS freeze_enabled BOOLEAN NOT NULL DEFAULT true;

ALTER TABLE organization_settings
  DROP COLUMN IF EXISTS freeze_deducts_lesson;
