-- Fix orphan cleanup: drop ambiguous 2-arg overload, clear FK blockers before auth delete

DROP FUNCTION IF EXISTS dev_console_cleanup_orphan_auth_users(uuid, boolean);
