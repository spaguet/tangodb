-- Fix payer resolution in record_personal_lesson_payment when payer_client_id is set.
...
BEGIN
  ...
  v_payer_id := COALESCE(p_client_id, v_lesson.payer_client_id, v_lesson.client_id1);
