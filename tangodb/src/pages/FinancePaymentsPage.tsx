                ...
                {canRemoveOrphanStorno ? (
                  <div className="sm:col-span-2 lg:col-span-3 pt-1">
                    <button
                      ...
                      className="w-full sm:w-auto px-3 py-2 rounded-lg text-xs font-semibold text-rose-700 bg-rose-50 hover:bg-rose-100 border border-rose-200 cursor-pointer transition-colors"
                    >
