...
function FinanceCostEntryRow({
  ...
  return (
    <div className="grid grid-cols-[1fr_auto] gap-3 items-center px-3 py-3 border-b border-ink-100 last:border-b-0">
      ...
      <p className="text-sm font-semibold text-garnet-700 whitespace-nowrap">
...
function ExpenseRow({
  ...
  return (
    <div className="grid grid-cols-[1fr_auto] sm:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto_auto] gap-2 sm:gap-3 items-center px-3 py-3 border-b border-ink-100 last:border-b-0 group">
      <div className="min-w-0">
        <p className="text-sm font-semibold text-ink-800 truncate">
      ...
      <p className="text-xs text-ink-500 font-sans hidden sm:block truncate">{categoryLabel(expense.category)}</p>
      <p className="text-sm font-sans font-semibold text-garnet-700 text-right whitespace-nowrap">
      ...
      {canWrite && (
        <div className="flex items-center justify-end gap-1 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
          <button
            ...
            aria-label="Edit"
            className="p-1.5 text-ink-400 hover:text-gold-800 hover:bg-gold-50 rounded-lg cursor-pointer"
          >
          ...
          <button
            ...
            aria-label="Delete"
            className="p-1.5 text-ink-400 hover:text-garnet-600 hover:bg-garnet-50 rounded-lg cursor-pointer"
          >
...
export default function FinanceExpensesPage() {
  ...
  return (
    <div className="panel-page-stack">
      <div className="bg-white rounded-xl border border-ink-200 shadow-xs overflow-hidden">
        <div className="px-4 py-3 border-b border-ink-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <h2 className="font-sans text-sm font-semibold text-ink-800">{t("finance.expenses.title")}</h2>
          </div>
        ...
        {items.length === 0 ? (
          <div className="py-8 text-center">
            <Receipt className="w-6 h-6 text-ink-300 mx-auto mb-2" />
          ...
          <>
            <div className="hidden sm:grid sm:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto_auto] gap-3 px-3 py-2 bg-ink-50 border-b border-ink-100 text-[10px] uppercase tracking-wider font-semibold text-ink-500 font-sans">
            ...
            <div className="px-4 py-3 border-t border-ink-100 flex justify-between items-center bg-ink-50/10">
              ...
              <span className="text-sm font-sans font-semibold text-ink-800">
      ...
      <div className="bg-white rounded-xl border border-ink-200 shadow-xs overflow-hidden">
        <div className="px-4 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-ink-50/40">
          <button
            type="button"
        ...
        {venueExpanded ? (
          sortedVenueEntries.length === 0 ? (
            <div className="px-4 py-6 text-center border-t border-ink-100">
              <p className="text-sm text-ink-500">{t("venueCosts.empty")}</p>
            </div>
          ) : (
      ...
      <div className="bg-white rounded-xl border border-ink-200 shadow-xs overflow-hidden">
        <div className="px-4 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-ink-50/40">
          ...
          <p className="text-sm font-semibold text-ink-800 whitespace-nowrap sm:pl-6">
        ...
        {teacherExpenseExpanded ? (
          financeCostsUnavailable ? (
            <div className="px-4 py-6 text-center border-t border-ink-100">
              <p className="text-sm text-ink-500">{t("venueCosts.finance.teacherExpenseEmpty")}</p>
            </div>
      ...
      <div className="bg-white rounded-xl border border-ink-200 shadow-xs px-4 py-3 flex justify-between items-center">
        <span className="text-xs text-ink-500 font-sans">{t("finance.expenses.title")}</span>
        <div className="text-right">
          <p className="text-sm font-sans font-semibold text-ink-800">
