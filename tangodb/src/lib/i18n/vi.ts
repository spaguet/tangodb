...
const VI_OVERRIDES: Partial<Record<I18nKey, string>> = {
  ...
  "team.inviteLinkHint": "Sau khi tạo, liên kết nằm trong danh sách chờ cho đến khi người được mời đăng nhập hoặc bạn thu hồi.",
  "team.inviteLinkOnceHint": "Có thể sao chép lại liên kết cho đến khi người được mời đăng nhập hoặc lời mời bị thu hồi.",
  "team.hideInviteLink": "Ẩn liên kết",
  "team.inviteLinkLabel": "Liên kết lời mời",
  "team.inviteLinkMissing": "Lời mời này không còn liên kết. Thu hồi và tạo lại.",
  "team.pendingInvites": "Lời mời đang chờ",
  "team.revoke": "Thu hồi",
  "team.deactivate": "Vô hiệu hóa",
  "team.changeRole": "Đổi vai trò",
  "team.audit": "Nhật ký thay đổi",
  "team.inviteSuccess": "Đã tạo lời mời. Liên kết nằm trong danh sách chờ.",
  "team.inviteError": "Không tạo được lời mời",
  ...
  "team.reinviteHint": "Vai trò và quyền đã điền — nhập email mới và tạo lời mời.",
