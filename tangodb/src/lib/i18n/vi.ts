...
const VI_OVERRIDES: Partial<Record<I18nKey, string>> = {
  ...
  "team.inviteLinkHint": "Sau khi tạo, hãy sao chép liên kết và gửi cho người được mời. Không lấy lại được từ danh sách chờ.",
  "team.inviteLinkOnceHint": "Liên kết chỉ hiện một lần kèm họ tên và email. Có thể tạo nhiều lời mời liên tiếp — mỗi liên kết giữ dữ liệu riêng.",
  ...
  "team.inviteSuccess": "Đã tạo lời mời. Sao chép liên kết bên dưới.",
