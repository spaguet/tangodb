        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-3 p-4 border-b border-ink-100">
              <div>
                <p className="text-base font-semibold text-ink-900">{t("corrections.rental.title")}</p>
                <p className="text-xs text-ink-500 mt-1">{t("corrections.rental.subtitle")}</p>
              </div>
            ...
            <div className="p-4 space-y-4">
              <div className="rounded-xl bg-ink-50 p-3 space-y-2 text-sm">
                ...
                <div className="flex justify-between gap-3">
                  <span className="text-ink-500">{t("corrections.rental.renter")}</span>
                  <span className="text-ink-800 truncate">{counterparty}</span>
                </div>
                <div className="flex justify-between gap-3">
