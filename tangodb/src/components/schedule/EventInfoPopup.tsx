            ...
            <div className="p-4 space-y-3 text-sm max-h-[70dvh] overflow-y-auto">
              ...
              {lesson.actualGuestCount != null ? (
                <div>
                  ...
                  <p className="text-slate-800">{lesson.actualGuestCount}</p>
                </div>
              ) : null}
              {lesson.comment ? (
                <div>
              ...
              <div className="flex flex-wrap gap-2 px-4 py-3 border-t border-slate-100 bg-slate-50/60">
                {canManage ? (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-violet-700 bg-violet-50 hover:bg-violet-100 border border-violet-200 rounded-lg cursor-pointer"
                  >
                ...
                {canRecordPayment ? (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 rounded-lg cursor-pointer"
                  >
