        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-3 p-4 border-b border-slate-100">
              <div>
                <p className="text-base font-semibold text-slate-900">{t("corrections.attendance.dialogTitle")}</p>
                <p className="text-xs text-slate-500 mt-1">{target.clientDisplay}</p>
              </div>
