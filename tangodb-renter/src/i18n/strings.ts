...
const messages = {
  ru: {
    ...
    bookingPurposeLabel: "Назначение аренды",
    bookingPurposePlaceholder: "Например, гимнастика",
    bookingModeOneTime: "Разовая",
    bookingModeRecurring: "Постоянная",
    recurringPack: "Постоянная аренда",
    packWeekCount: "Длительность",
    packWeeksOption: "{count} нед.",
    startTime: "Начало",
    endTime: "Конец",
    ...
    topupQrSaving: "Сохранение…",
    topupQrSaveWaitHint: "На некоторых устройствах сохранение может занять несколько секунд — дождитесь завершения.",
    ...
    walletEntryWalletPayout: "Возврат со студии",
    walletEntryWalletCorrectionCredit: "Правка баланса (+)",
    walletEntryWalletCorrectionDebit: "Правка баланса (−)",
    ...
    scheduleControlsExpand: "Развернуть панель расписания",
  ...
  en: {
    ...
    mineDebt: "Has debt",
    bookSlot: "Book",
    bookingPurposeLabel: "Rental purpose",
    bookingPurposePlaceholder: "e.g. gymnastics",
    bookingModeOneTime: "One-time",
    bookingModeRecurring: "Recurring",
    recurringPack: "Recurring rental",
    packWeekCount: "Duration",
    packWeeksOption: "{count} wk",
    startTime: "Start",
    endTime: "End",
    duration: "Duration",
    cost: "Cost",
    ...
    topupSaveQr: "Save QR",
    topupQrSaving: "Saving…",
    topupQrSaveWaitHint: "On some devices saving may take a few seconds — please wait until it finishes.",
    ...
    walletEntryWalletPayout: "Studio payout",
    walletEntryWalletCorrectionCredit: "Balance correction (+)",
    walletEntryWalletCorrectionDebit: "Balance correction (−)",
    ...
    nextWeek: "Next week",
    scheduleControlsExpand: "Expand schedule panel",
