              ...
              <div className="space-y-1.5">
                {todayPayments.map((p) => (
                  ...
                  >
                    ...
                    <span className="text-xs font-semibold text-indigo-700 shrink-0">{money(p.amount)}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-3.5 border border-slate-200/90 shadow-xs space-y-3">
              ...
              <div className="grid gap-3 grid-cols-2 lg:grid-cols-5">
                <div className="bg-slate-50 rounded-lg px-3 py-2.5 border border-slate-100">
                  ...
                  <p className="text-[10px] text-slate-500 mt-0.5">{paymentCountLabel(financialStats.paymentCount)}</p>
                </div>
                <div className="bg-slate-50 rounded-lg px-3 py-2.5 border border-slate-100">
                  <p className="text-[10px] text-slate-400 uppercase font-semibold tracking-wider">{s.dashboard.subscriptions}</p>
                  <p className="text-xl font-semibold text-indigo-700 mt-0.5">{money(financialStats.subscriptions)}</p>
                </div>
                <div className="bg-slate-50 rounded-lg px-3 py-2.5 border border-slate-100">
                  <p className="text-[10px] text-slate-400 uppercase font-semibold tracking-wider">{s.dashboard.personal}</p>
                  <p className="text-xl font-semibold text-indigo-700 mt-0.5">{money(financialStats.personal)}</p>
                </div>
                <div className="bg-slate-50 rounded-lg px-3 py-2.5 border border-slate-100">
                  <p className="text-[10px] text-slate-400 uppercase font-semibold tracking-wider">{s.dashboard.singleVisits}</p>
                  <p className="text-xl font-semibold text-indigo-700 mt-0.5">{money(financialStats.singleVisits)}</p>
                </div>
                <div className="bg-slate-50 rounded-lg px-3 py-2.5 border border-slate-100">
                  <p className="text-[10px] text-slate-400 uppercase font-semibold tracking-wider">{s.dashboard.receivables}</p>
                  <p className="text-xl font-semibold text-rose-700 mt-0.5">{money(financialStats.receivables)}</p>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 pt-1 border-t border-slate-100">
                <div className="bg-slate-50 rounded-lg px-3 py-2.5 border border-slate-100">
                  ...
                  <p className="text-xl font-semibold text-rose-700 mt-0.5">{money(financialStats.expenses)}</p>
                </div>
                <div className="bg-slate-50 rounded-lg px-3 py-2.5 border border-slate-100">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                  {paymentByMethod
                    ...
                    .map((row) => (
                      ...
                      >
                        <span className="text-slate-500">{paymentMethodLabel(row)}</span>
                  ...
                  <div className="space-y-1.5">
                    {topClients.map((c, i) => (
                      <div key={c.name} className="flex items-center justify-between text-xs px-2 py-1.5 bg-white rounded-lg border border-slate-100">
                        ...
                        <span className="font-semibold text-indigo-700">{money(c.amount)}</span>
                      </div>
                    ))}
                  </div>
                </div>
