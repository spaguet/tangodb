          ...
          {items.map(({ titleKey, textKey, href, external }, index) => {
            ...
            const titleEl = resolvedHref ? (
              <a
                ...
                className="text-sm font-semibold text-ink-900 transition-colors hover:text-gold-700"
            ...
            return (
              <div
                key={titleKey}
                className={[
                  index > 0 ? "border-t border-ink-100 pt-8 md:border-t-0 md:border-l md:pt-0" : "",
                  index > 0 ? "md:pl-8" : "",
              ...
              >
                {titleEl}
                <p className="mt-2 text-sm leading-relaxed text-ink-600">{t(textKey)}</p>
              </div>
            );
          })}
        </div>
