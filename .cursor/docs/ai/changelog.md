...
2026-08-04 — fix: настройки «Аренда зала» — кнопки «Сохранить»/«Отмена» черновика правила venue cost перенесены выше блока массового копирования (были скрыты под длинной формой при правилах персональных уроков).
