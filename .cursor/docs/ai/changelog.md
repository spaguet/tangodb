...
2026-06-22 — Расписание Промпт 8: фильтр преподавателя в ScheduleToolbar (AppSelect, client-side filter DisplayLesson[]); URL ?teacher=uuid; teacher без full schedule видит только себя в списке.
