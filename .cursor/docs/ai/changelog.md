2026-09-02 — feat(hall-rent): микропатч **2.9.32** — Mini App: шапка только из вкладок «Расписание»/«Мои записи»; «Мои записи» в стиле CRM; занятые ячейки темнее с серой обводкой, «Моя бронь» — indigo CRM.
