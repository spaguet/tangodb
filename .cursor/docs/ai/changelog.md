2026-09-10 — fix(hall-rent): Mini App **0.1.9** — «Пополнить» из формы брони открывает лист пополнения поверх попапа (вкладка «Мой профиль» больше не уходит на фон); после чека или наличных обязательна кнопка «Отправить заявку в CRM».
