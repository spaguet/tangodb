...
2026-06-20 — RBAC R1+R2 §9: org-setting overrides (teachers_can_*, admin_can_*) — миграция, permissions.ts читает флаги из OrganizationSettings, UI «Расширенные права ролей». роль «Кассир» через admin + meta.restricted_admin — миграция, RLS helpers, permissions guards, invite preset в TeamSettingsPage.
