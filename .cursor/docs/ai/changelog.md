...
2026-08-04 — fix: после оплаты персонального урока в расписании — toast «Урок оплачен» вместо технического «Сохранено · операция {op}»; плейсхолдеры `{{op}}` в строках corrections.
