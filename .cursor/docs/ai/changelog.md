...
2026-08-04 — fix: оплата персонального урока из расписания — в `PayPersonalLessonModal` добавлен выбор способа оплаты (наличные / перевод / карта / другое); раньше метод всегда записывался как `cash`.
