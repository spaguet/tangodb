...
- [ ] **S2c** — атомарный Inbox Activate month/lifetime + Billing
- [ ] **S2d** — RLS: отозвать authenticated INSERT заявок
- [ ] **S3a** — RBAC/гейты/waitlist/`LicenseRequired` (панель покупки ещё не monthly)
