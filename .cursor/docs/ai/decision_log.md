...
- **Следующие шаги:** Промпт 1 (lib, выполнен) → Промпт 2 (SQL) → Промпт 3 (RPC) → UI прайс/продажа/касса/дебиторка/журнал (Промпты 4–8) → закрытие `2.8.0` (Промпт 9). Промпт 10 — только при подтверждённом split 50/50.
